...
urlpatterns = [
    ...
    path('transport_list_/<int:pk>', TransportListDetail.as_view(), name='transport_list_detail'),
    path('transport_list/add/', TransportListCreate.as_view(), name='transport_add'),
    path('transport_list/<int:pk>/del/', TransportListDel.as_view(), name='transport_del'),
